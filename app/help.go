...
func (h helpTypeGeneral) toContent() string {
	content := lipgloss.JoinVertical(lipgloss.Left,
		...
		keyStyle.Render("n")+descStyle.Render("         - New instance (worktree, no-worktree, or directory)"),
		keyStyle.Render("N")+descStyle.Render("         - New instance with a prompt"),
		keyStyle.Render("a")+descStyle.Render("         - Attach to an existing worktree"),
